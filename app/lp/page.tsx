...
export default function LandingPage() {
  useEffect(() => {
    const slides = [
      { label: "RAKENNUSLIIKKEET" },
      { label: "MAANSIIRTOURAKOITSIJAT" },
      { label: "SÄHKÖASENTAJAT" },
      { label: "LVI-URAKOITSIJAT" },
      { label: "MAALAUSLIIKKEET" },
    ];
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .hero-overlay{position:absolute;inset:0;background:linear-gradient(170deg,rgba(8,17,31,0.85) 0%,rgba(8,17,31,0.6) 50%,rgba(8,17,31,0.95) 100%);pointer-events:none;z-index:1;}
        ...
        .hero-sub{font-size:clamp(1rem,1.8vw,1.2rem);color:rgba(255,255,255,.58);max-width:500px;margin:0 auto 2.5rem;line-height:1.65;}
        ...
        .final-bg{position:absolute;inset:0;background:url('https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1600&q=80') center center/cover no-repeat;pointer-events:none;}
      ...
      <nav className="lp-nav">
        <div className="lp-logo">Tarjous<b>|</b>kone</div>
      ...
      <section className="lp-hero">
        <div className="bg-layer active" style={{backgroundImage:"url('https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1800&q=80')"}}></div>
        <div className="bg-layer" style={{backgroundImage:"url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1800&q=80')"}}></div>
        <div className="bg-layer" style={{backgroundImage:"url('https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=1800&q=80')"}}></div>
        <div className="bg-layer" style={{backgroundImage:"url('https://images.unsplash.com/photo-1607400201515-c2c41c9c82f4?w=1800&q=80')"}}></div>
        <div className="bg-layer" style={{backgroundImage:"url('https://images.unsplash.com/photo-1562259929-b4e1fd3aef09?w=1800&q=80')"}}></div>
        <div className="hero-overlay"></div>
        <div className="hero-glow"></div>
        <div className="hero-inner">
          <div className="eyebrow" id="eyebrow">
            <span className="eyebrow-dot"></span>
            <span id="eyebrow-text">RAKENNUSLIIKKEET</span>
          </div>
          <h1 className="lp-h1">Tee tarjous<em>2 minuutissa.</em></h1>
          <p className="hero-sub">
          <span className="slogan-wrap" id="slogan-wrap" style={{minWidth:"320px",verticalAlign:"bottom"}}>
            <span className="slogan-word enter" id="slogan-0">Lopeta pään raapiminen.</span>
            <span className="slogan-word below" id="slogan-1">Lopeta sähläys.</span>
            <span className="slogan-word below" id="slogan-2">Lopeta tuntien tuhlaus.</span>
          </span>
          {" "}<b>AI kirjoittaa tarjouksen,</b> asiakas allekirjoittaa suoraan selaimessa. Valmis.
        </p>
          <div className="btns">
          ...
          <div className="proof-row">
            ...
            <div className="proof-item"><span>✓</span> Valmis alle minuutissa</div>
            <div className="proof-item"><span>✓</span> eIDAS-allekirjoitus</div>
            <div className="proof-item"><span>✓</span> ALV 25,5 % automaattisesti</div>
          </div>
        </div>
      ...
      <div className="ticker">
        <div className="ticker-track">
          {["AI KIRJOITTAA","✦","SÄHKÖINEN ALLEKIRJOITUS","✦","2 MINUUTTIA","✦","eIDAS-PÄTEVÄ","✦","ALV 25,5 %","✦","TARJOUSARKISTO","✦",
            "AI KIRJOITTAA","✦","SÄHKÖINEN ALLEKIRJOITUS","✦","2 MINUUTTIA","✦","eIDAS-PÄTEVÄ","✦","ALV 25,5 %","✦","TARJOUSARKISTO","✦"].map((t,i)=>(
      ...
      <section className="pain">
        <div className="pain-head">
          ...
          <h2>Lopeta turha työ. <span>Aloita tänään.</span></h2>
        </div>
        <div className="pain-grid">
          {[
            {b:"Excel-pohja, copy-paste ja hinta laskettuna käsin — tunnin työ joka kerta", a:"Syötä projektin tiedot → valmis ammattitarjous alle minuutissa"},
            {b:"Asiakas tulostaa, allekirjoittaa, skannaa ja lähettää takaisin sähköpostilla", a:"Asiakas klikkaa linkkiä — sähköinen allekirjoitus 60 sekunnissa"},
            {b:"Tarjous hukkuu sähköpostiin — et tiedä onko sitä edes avattu", a:"Arkisto näyttää reaaliajassa: lähetetty → avattu → allekirjoitettu"},
          ].map((item,i)=>(
            <div className="pain-col" key={i}>
              ...
              <div className="tag-after">TARJOUSKONEELLA</div>
      ...
      <section className="steps" id="steps">
        <div className="steps-head">
          ...
          <div className="steps-h2">Kolme askelta. Valmis tarjous.</div>
          <p className="steps-sub">Ei koulutusta, ei asennuksia — toimii heti selaimessa.</p>
        </div>
        <div className="steps-row">
          {[
            {n:"1", h:"Syötä projektin tiedot", p:"Kerro asiakkaan nimi, kohteen sijainti ja mitä urakka sisältää. Voit liittää myös piirustuksen tai valokuvan kohteesta."},
            {n:"2", h:"AI luo tarjouksen", p:"Ammattimainen tarjous hintaerittelyineen syntyy sekunnissa. ALV 25,5 % lasketaan automaattisesti."},
            {n:"3", h:"Asiakas allekirjoittaa", p:"Asiakas saa sähköpostiin henkilökohtaisen linkin ja hyväksyy tarjouksen sähköisesti. Molemmat saavat vahvistuksen."},
          ].map((s,i)=>(
      ...
      <section className="numbers">
        <div className="num-inner">
          <div><div className="num-v">2 min</div><div className="num-l">TARJOUKSEN TEKO</div></div>
          <div><div className="num-v">25,5 %</div><div className="num-l">ALV AUTOMAATTISESTI</div></div>
      ...
      <section className="demo">
        <div className="demo-inner">
          <div className="demo-text">
            ...
            <h2>Näe miten se toimii. Heti.</h2>
            <p>Avaa demo, syötä projektin tiedot ja katso miten valmis tarjous syntyy silmien edessä. Ei rekisteröitymistä, ei asennuksia.</p>
            <a href="/tarjouskone?demo=1" className="btn-gold">Avaa demo →</a>
          </div>
          <div className="demo-box">
            <div className="demo-badge">LIVE DEMO</div>
            <div style={{fontSize:".62rem",fontWeight:700,letterSpacing:".1em",color:"rgba(255,255,255,.28)",marginBottom:".9rem"}}>AI GENEROI TARJOUSTA...</div>
            <div className="demo-loading"><div className="demo-loading-fill"></div></div>
            <div className="demo-line"><div className="demo-dot-gold"></div><div className="demo-line-t"><b>Projekti:</b> Kylpyhuoneremontti, Tampere</div></div>
            <div className="demo-line"><div className="demo-dot-gold"></div><div className="demo-line-t"><b>Työ:</b> LVI 3 pv + materiaali 1 800 €</div></div>
            <div className="demo-line"><div className="demo-dot-gold"></div><div className="demo-line-t"><b>ALV 25,5 %:</b> laskettu automaattisesti</div></div>
            <div className="demo-done">✓ Tarjous valmis — lähetä asiakkaalle</div>
          </div>
        </div>
      </section>
      ...
      <section className="testi">
        ...
        <p className="testi-q">Ennen tarjouksen teko vei tunnin. Nyt <em>2 minuuttia</em> ja asiakas saa linkin suoraan puhelimeensa. En palaa enää Exceliin.</p>
        <div className="testi-who">
          <div className="testi-av">M</div>
          <div>
            <div className="testi-name">Mikko R.</div>
            <div className="testi-role">LVI-urakoitsija, Tampere</div>
          </div>
        </div>
      </section>
      ...
      <section className="pricing" id="pricing">
        ...
        <div className="p-grid">
          <div className="p-card">
            ...
            <p className="p-d">Pienelle toimistolle tai yksittäiselle asiantuntijalle.</p>
            <ul className="p-ul">
              {["10 tarjousta / kk","AI-tarjousgeneraattori","Sähköinen allekirjoitus","Tarjousarkisto","Sähköpostilähetys"].map(f=><li key={f}><span className="ck">✓</span>{f}</li>)}
            </ul>
          ...
          <div className="p-card hi">
            ...
            <ul className="p-ul">
              {["Rajaton määrä tarjouksia","AI-tarjousgeneraattori","Sähköinen allekirjoitus","Tarjousarkisto","Sähköpostilähetys","PDF-liitteet & piirustukset"].map(f=><li key={f}><span className="ck">✓</span>{f}</li>)}
            </ul>
      ...
      <section className="lp-final">
        ...
        <div className="final-inner">
          <h2>Lopeta sähläys.<em>Aloita tänään.</em></h2>
      ...
      <footer className="lp-footer">
        <div className="foot-in">
          <div className="foot-logo">Tarjous|kone</div>
          ...
          <div className="foot-copy">© 2026 CertusLex / Tarjouskone</div>
        </div>
      </footer>
